                    ...
                    <div key={index}>
                      <li className="flex py-6 sm:py-6 ">
                        ...
                        <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                          {/* Here i remove className "relative" */}
                          <div className=" pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                            <div>
                              <div className="flex justify-between">
                                <h3 className="text-sm">
                                  <a href={items.href} className="font-semibold text-black">
                                    {items.name}
                                  </a>
                                </h3>
                              </div>
                              <div className="mt-1 flex text-sm">
                                <p className="text-sm text-gray-500">{items.color}</p>
                                {items.size ? (
                              ...
                              <div className="mt-1 flex items-end">
                                ...
                                &nbsp;&nbsp;
                                <p className="text-sm font-medium text-green-500">{items.discount}</p>
                              </div>
                            </div>
                          </div>
                        </div>
